...
def wishMe():
    ...
    speak("namusthae")
    print("नमसते")
    speak("mae hoon vidheeker, how may I help you")
    print("मैं विधिकर..... how may i help you")
...
def sendEmail(to,content):
    ...
    server.ehlo()
    server.starttls()
    server.login("babu2003nov@gmail.com","")
    server.sendmail("babu2003nov@gmail.com",to,content)
    server.close
    ...
    while True:
        ...
        if "wikipedia" in query:
            ...
            print('''          Just say == it will do this
                    ...
                    a list              == opens to do list
                    can we talk         == starts the chatbot feature 
                    play game           == asks to play which game 
                    Note:
            ...
            music_dir = 'C:\\Users\\kbose\\Desktop\\INVENTORY\\Music'
            ...
            codePath = "C:\\Users\\kbose\\AppData\\Local\\Programs\\Microsoft VS Code\\Code.exe"
            ...
            if "play game" in query:
                ...
                if "exit" in query:
                    speak("Ok it was nice talking to you")
                    exit()
                else:
